view: getlife_v_vis_finance_pl_input_comms_monthly_policies_cons {
  sql_table_name: `getlife_v_vis_finance.getlife_v_vis_finance_PL_input_comms_monthly_policies_cons`
    ;;
  drill_fields: [id]
  ...
  dimension: carrier_commission {
    type: number
    sql: ${TABLE}.Carrier_commission ;;
  }
