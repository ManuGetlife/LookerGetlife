view: getlife_v_vis_finance_pl_input_comms_annual_policies_cons {
  sql_table_name: `getlife_v_vis_finance.getlife_v_vis_finance_PL_input_comms_annual_policies_cons`
    ;;
  drill_fields: [id]
